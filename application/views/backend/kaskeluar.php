                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <?php $i = 1 ; foreach ($kaskeluar as $row ) { ?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a id="edit_data" data-toggle="modal" data-target="#edit" data-id="<?php echo $row['kode']; ?>" data-ket="<?php echo $row['keterangan']; ?>" data-tgl="<?php echo $row['tgl']; ?>" data-jml="<?php echo $row['keluar']; ?>" class="btn btn-warning btn-sm" title="Ubah Data"><i class="fa fa-edit"> </i></a>
                                                <a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="<?php echo base_url().'admin/kaskeluar_hapus/'.$row['kode']; ?>" class="btn btn-danger btn-md" title="Hapus Data"><i class="fa fa-trash"> </i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 17px; text-align: right; "><font style="color: green;"><?php echo "Rp. " . number_format($totalkeluar); ?>,-</font></td>
                                </tr>
                            </table>
                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" action="<?php echo base_url()?>admin/keluarkas" method="POST">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" id="modal_edit">
                                                <form role="form" action="<?php echo base_url()?>admin/kaskeluar_update" method="POST">
                                                    <div class="form-group">
                                                        <label>Kode</label>
